...
--
-- Host: 127.0.0.1
-- Generation Time: May 21, 2020 at 06:04 PM
...
(2016050001, 'd8578edf8458ce06fbc5bb76a58c5ca4', 'qwerty', 'Andriansyah Doni', 'Perum Duta Asri Palem 2, Pasar Kemis. Tangerang', 'doni@localhost', 'Y', 'Admin', '143250avatar-foto1.jpg', 'A5JOYDPGAy', 'Y', '2020-04-26', '23:26:05'),
...
(17, 'Teknik Kendaraan Ringan', 'Y'),
(18, 'Akomodasi Perhotelan', 'Y');
...
CREATE TABLE `psb` (
  ...
  `pil_komp_1` int(3) NOT NULL,
  `pil_komp_2` int(3) NOT NULL,
  `pil_komp_3` int(3) NOT NULL,
  `id_kompetensi` int(3) NOT NULL,
...
INSERT INTO `psb` (`no_reg`, `tgl_daftar`, `jam_daftar`, `password`, `kode_aktivasi`, `status_aktivasi`, `status_verifikasi`, `pil_komp_1`, `pil_komp_2`, `pil_komp_3`, `id_kompetensi`, `nis`, `nisn`, `nm_siswa`, `tmp_lahir`, `tgl_lahir`, `jns_kelamin`, `agama`, `anak_ke`, `jml_saudara`, `status_anak`, `tinggi_badan`, `berat_badan`, `gol_darah`, `alamat_siswa`, `kota_kab`, `kode_pos`, `hp_siswa`, `tlp_siswa`, `email_siswa`, `status_rumah_siswa`, `kendaraan`, `asal_sekolah`, `alamat_sekolah`, `no_ijazah`, `tgl_ijazah`, `thn_ijazah`, `nilai_un`, `prestasi_akademik`, `prestasi_olahraga`, `prestasi_kesenian`, `nm_orangtua_ayah`, `nm_orangtua_ibu`, `pekerjaan_ayah`, `pekerjaan_ibu`, `penghasilan_ayah`, `penghasilan_ibu`, `alamat_orgtua`, `kota_kab_orgtua`, `kode_pos_orgtua`, `hp_orgtua`, `nm_wali`, `pekerjaan_wali`, `penghasilan_wali`, `alamat_wali`, `hp_wali`, `penanggung_biaya`) VALUES
('PSB20050001', '2020-05-21', '22:43:06', 'e7f0f58790', '', 'N', 'Belum', 0, 0, 0, 0, '', 1921680002, 'Akbar', '', '0000-00-00', 'L', '', 0, 0, '', 0, 0, '', '', '', 0, '', '', '', '', '', 'SMP NEGERI 1 WANO', '', '', '0000-00-00', 0000, 0, '', '', '', '', '', '', '', 0, 0, '', '', 0, '', '', '', 0, '', '', ''),
('PSB20050002', '2020-05-21', '22:43:48', '3ae9095880', '', 'N', 'Belum', 0, 0, 0, 0, '', 1921680001, 'ull prasetio', '', '0000-00-00', 'L', '', 0, 0, '', 0, 0, '', '', '', 0, '', '', '', '', '', 'SMP NEGERI 1 WANO', '', '', '0000-00-00', 0000, 0, '', '', '', '', '', '', '', 0, 0, '', '', 0, '', '', '', 0, '', '', '');
...
('USM20040010', 'PSB20040004', '2020-04-28', '00:00:00', '', 0, 'Belum');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `views_ujian_masuk`  AS  select `psb`.`psb`.`no_reg` AS `no_reg`,`psb`.`psb`.`nm_siswa` AS `nm_siswa`,`psb`.`psb`.`nisn` AS `nisn`,`psb`.`psb`.`asal_sekolah` AS `asal_sekolah`,`psb`.`ujian_masuk`.`ket_ujian` AS `ket_ujian` from (`psb`.`psb` join `psb`.`ujian_masuk` on(`psb`.`psb`.`no_reg` = `psb`.`ujian_masuk`.`no_reg`)) ;
...
--
ALTER TABLE `kompetensi`
  MODIFY `id_kompetensi` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
COMMIT;
